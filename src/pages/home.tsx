        ...
        return (
            <div className="trans" id="homecnt">
                ...
                <div className="text-tl center inline tgl-me">
                    ...
                    <br />
                    Having previous experience in Programming making plugins for older games in lua API's, I have now made a few sites with <span className="fancy-blue tgl-me">React</span> and <span className="fancy-lora tgl-me">JS</span> <br />
                    <br />
                ...
                <div className="text-bt center tgl-me">
                    Now additionally there is this site, which serves as one of the Portfolios to show off what I can do. <br />
                    <br /> 
